...
namespace H.Core.Calculators.Nitrogen
{
    public partial class N2OEmissionFactorCalculator
    {
        ...
        public double CalculateN2ONFromVolatilizationOfFarmSourcedLandAppliedManureForField(int year, Farm farm, CropViewItem cropViewItem)
        {
            ...
            var emissionFactorForVolatilization = this.GetEmissionFactorForVolatilization(farm, cropViewItem);
            ...
            int year)
        {
            ...
            var emissionFactorForVolatilization = this.GetEmissionFactorForVolatilization(farm, viewItem);
            ...
            bool includeRemainingAmounts = true)
        {
            ...
            var volatilizationFromImportedManure = ammoniaFromImportedManure * this.GetEmissionFactorForVolatilization(farm, cropViewItem);
        ...
        private double GetEmissionFactorForVolatilization(Farm farm, CropViewItem viewItem)
        {
            var precipitation = this.ClimateProvider.GetAnnualPrecipitation(farm, viewItem);
            var evapotranspiration = this.ClimateProvider.GetAnnualEvapotranspiration(farm, viewItem);
            var emissionFactorForVolatilization = this.LivestockEmissionConversionFactorsProvider.GetEmissionFactorForVolatilizationBasedOnClimate(precipitation, evapotranspiration);
        ...
        private double GetAdjustedAmmoniaEmissionFactor(
            ...
            ManureApplicationViewItem manureApplicationViewItem)
        {
            var averageDailyTemperature = this.ClimateProvider.GetMeanTemperatureForDay(farm, cropViewItem, manureApplicationViewItem.DateOfApplication);
        ...
        {
            var growingSeasonPrecipitation = this.ClimateProvider.GetGrowingSeasonPrecipitation(farm, viewItem);
            var growingSeasonEvapotranspiration = this.ClimateProvider.GetGrowingSeasonEvapotranspiration(farm, viewItem);
            var leachingFraction = this.CalculateLeachingFraction(growingSeasonPrecipitation, growingSeasonEvapotranspiration);
